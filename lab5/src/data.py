...
def get_flow_normalization(flow_values_path = '/espace/DLCV/Data/max_flow_values.npy', visualization = 0, show = False, method = '99.99%'):
...
#############################################################################
def get_data(action_path, flow_normalization, class_index, data_path = '/espace/DLCV/Data', augmentation = 0,
